...
use_tm = 0 # if use_tm
result_dir = "./dqn_result/dqn_result10/eval/"
...
class DQNAgent:
    def __init__(
        ...
        self.dqn = torch.load("./dqn_result/dqn_result10/" + self.env.service_name + ".pth")
    ...
    def train(self, episodes: int, event):
        ...
        torch.save(self.dqn, result_dir + self.env.service_name + '.pth')
